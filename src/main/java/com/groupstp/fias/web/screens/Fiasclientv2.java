...
//            options.put("cityId", (cityField.getValue()));
    ...
    private Stead processSteadEntity(STEADS.STEAD fiasStead, Stead entity) {
        ...
        Stead stead = entity;
        stead.__getEntityEntry().setAttributeValue("parentAdm", parentEntityAdm, true);
        stead.__getEntityEntry().setAttributeValue("parentMun", parentEntityMun, true);
        stead.__getEntityEntry().setAttributeValue("garId", fiasStead.getOBJECTID().longValue(), true);
        stead.__getEntityEntry().setAttributeValue("number", fiasStead.getNUMBER(), true);
        stead.__getEntityEntry().setAttributeValue("isactive", fiasStead.getISACTIVE().intValue() == 1, true);
        stead.__getEntityEntry().setAttributeValue("isactual", fiasStead.getISACTUAL().intValue() == 1, true);
        stead.__getEntityEntry().setAttributeValue("startdate", fiasStead.getSTARTDATE().toGregorianCalendar().getTime(), true);
        stead.__getEntityEntry().setAttributeValue("updatedate", fiasStead.getUPDATEDATE().toGregorianCalendar().getTime(), true);
        stead.__getEntityEntry().setAttributeValue("enddate", fiasStead.getENDDATE().toGregorianCalendar().getTime(), true);
        stead.__getEntityEntry().setAttributeValue("addressLevel", 9);
    ...
    private House processHouseEntity(HOUSES.HOUSE fiasHouse, House entity) {
        ...
        House house = entity;
        house.__getEntityEntry().setAttributeValue("parentAdm", parentEntityAdm, true);
        house.__getEntityEntry().setAttributeValue("parentMun", parentEntityMun, true);

        if (parameters.containsKey(fiasHouse.getOBJECTID())) {
            Map<String, Object> values = parameters.get(fiasHouse.getOBJECTID());
            values.forEach((k, v) -> house.__getEntityEntry().setAttributeValue(k.toString(), v, true));
        }
        house.__getEntityEntry().setAttributeValue("garId", fiasHouse.getOBJECTID(), true);
        house.__getEntityEntry().setAttributeValue("housenum", fiasHouse.getHOUSENUM(), true);
        house.__getEntityEntry().setAttributeValue("buildnum", fiasHouse.getADDNUM1(), true);
        house.__getEntityEntry().setAttributeValue("strucnum", fiasHouse.getADDNUM2(), true);
        house.__getEntityEntry().setAttributeValue("isactive", fiasHouse.getISACTIVE().intValue() == 1, true);
        house.__getEntityEntry().setAttributeValue("isactual", fiasHouse.getISACTUAL().intValue() == 1, true);
        house.__getEntityEntry().setAttributeValue("startdate", fiasHouse.getSTARTDATE().toGregorianCalendar().getTime(), true);
        house.__getEntityEntry().setAttributeValue("updatedate", fiasHouse.getUPDATEDATE().toGregorianCalendar().getTime(), true);
        house.__getEntityEntry().setAttributeValue("enddate", fiasHouse.getENDDATE().toGregorianCalendar().getTime(), true);
        house.__getEntityEntry().setAttributeValue("addressLevel", 10);
    ...
    private <T extends FiasEntity> FiasEntity loadFiasEntity(Class<T> clazz, ADDRESSOBJECTS.OBJECT object) {
        ...
        entity.__getEntityEntry().setAttributeValue("name", object.getNAME(), true);
        entity.__getEntityEntry().setAttributeValue("offname", object.getNAME(), true);
        entity.__getEntityEntry().setAttributeValue("shortname", object.getTYPENAME(), true);
        entity.__getEntityEntry().setAttributeValue("parentAdm", parentAdm, true);
        entity.__getEntityEntry().setAttributeValue("parentMun", parentMun, true);
...
//
        entity.__getEntityEntry().setAttributeValue("updatedate", object.getUPDATEDATE().toGregorianCalendar().getTime(), true);
        entity.__getEntityEntry().setAttributeValue("actstatus", FiasEntityStatus.fromId(object.getISACTUAL().intValue()), true);
        entity.__getEntityEntry().setAttributeValue("startdate", object.getSTARTDATE().toGregorianCalendar().getTime(), true);
        entity.__getEntityEntry().setAttributeValue("enddate", object.getENDDATE().toGregorianCalendar().getTime(), true);
        entity.__getEntityEntry().setAttributeValue("prevID", object.getPREVID(), true);
        entity.__getEntityEntry().setAttributeValue("garId", object.getOBJECTID(), true);
        entity.__getEntityEntry().setAttributeValue("addressLevel", object.getLEVEL());
        return entity;
    }
